...
$mail->Host = 'mail.myhoneystone.ca'; // Specify main and backup SMTP servers
$mail->SMTPAuth = true; // Enable SMTP authentication
$mail->Username = 'info@myhoneystone.ca'; // SMTP username
$mail->Password = 'mail@myhoneystone'; // SMTP password
$mail->SMTPSecure = 'tls'; // Enable TLS encryption, `ssl` also accepted
$mail->Port = 587; // TCP port to connect to

$mail->setFrom('info@myhoneystone.ca', $_POST['name']);
...
$mail->Subject = "Honeystone Homes - Landing Page Inquiry";
$message = '<html>
